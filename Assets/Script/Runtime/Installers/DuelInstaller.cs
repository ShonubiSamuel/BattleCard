...
public sealed class DuelInstaller : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // ServiceLocator.Register<IChangePositionCommandService>(
        //     new ChangePositionCommandService(
        //         ServiceLocator.Get<ActionQueue>(),
        //         ServiceLocator.Get<TurnManager>(),
        //         ServiceLocator.Get<ICardIndex>(),
        //         ServiceLocator.Get<DuelLogger>()), overwrite:true);
